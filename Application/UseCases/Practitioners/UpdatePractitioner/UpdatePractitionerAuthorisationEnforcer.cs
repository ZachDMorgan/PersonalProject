...
namespace Application.UseCases.Practitioners.UpdatePractitioner
{
    ...
    public class UpdatePractitionerAuthorisationEnforcer : IAuthorisationEnforcer<UpdatePractitionerInputPort, IUpdatePractitionerOutputPort>
    {
        ...
        public UpdatePractitionerAuthorisationEnforcer(IAuthorisationClaimsProvider authorisationClaimsProvider)
        ...
        async Task<IContinuationResult> IAuthorisationEnforcer<UpdatePractitionerInputPort, IUpdatePractitionerOutputPort>.AuthoriseAsync(
